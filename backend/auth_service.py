...
class AuthService:
    ...
    async def create_user_invitation(self, email: str, role: UserRole, 
        ...
        invite_url = f"https://dynamic-fun.preview.emergentagent.com/accept-invite?token={invitation.invitation_token}"
    ...
    async def create_password_reset(self, email: str) -> bool:
        ...
        # Send reset email
        reset_url = f"https://dynamic-fun.preview.emergentagent.com/reset-password?token={reset_token.token}"
    ...
    async def create_email_verification(self, user_id: str, email: str) -> EmailVerification:
        ...
        verification_url = f"https://dynamic-fun.preview.emergentagent.com/verify-email?token={verification.token}"
